 ...
 *
 * Each preset is grounded in a research lane (high-angle RWD competition, JDM touge,
 * limit handling, grip racing, rally, and iconic car archetypes). See the comment
 ...
 */
#ifndef CIRCUIT_DEV_PRESETS_H
#define CIRCUIT_DEV_PRESETS_H
