...
static const DevParameter g_params[] = {
    ...
    { "body.frontal_area", "Body", "m^2", SPEC_OFFSET(frontalAreaM2), FRONTAL_AREA_M2, 1.0f,
      8.0f, 0.05f, false, true, 1, "Frontal area from width*height*fill (derived)." },
    ...
    { "drive.diff_mode", "Drivetrain", "", SPEC_OFFSET(differentialMode), 0.0f, 0.0f, 2.0f,
      1.0f, false, false, 1, "0=locked 1=open 2=LSD." },
...
void dev_params_write_markdown(FILE *out)
{
    ...
    fprintf(out, "<!-- Generated by `build/tests/drifty_tests.exe --dump-params`. Do not edit "
                 "by hand. -->\n");
