...
static const DevParameter g_params[] = {
    ...
    { "tire.wear_enabled", "Tires", "", SPEC_OFFSET(tireWearEnabled), 0.0f, 0.0f, 1.0f, 1.0f,
      false, false, 2, DEV_CLASS_PHYSICS_INPUT, DEV_OWNER_DEFINITION,
      "Tire wear model master switch (#22). 0 = off, baseline exact." },
    ...
    { "drive.engine_inertia", "Drivetrain", "kg*m^2", SPEC_OFFSET(engineInertiaKgM2), 0.0f,
      0.0f, 10.0f, 0.1f, false, false, 2, DEV_CLASS_PHYSICS_INPUT, DEV_OWNER_DEFINITION,
      "Dynamic engine inertia (#23). 0 = kinematic engine, baseline exact." },
    { "drive.max_clutch_torque", "Drivetrain", "N*m", SPEC_OFFSET(maxClutchTorqueNm), 400.0f,
      50.0f, 5000.0f, 10.0f, false, false, 2, DEV_CLASS_PHYSICS_INPUT, DEV_OWNER_DEFINITION,
      "Clutch torque capacity while slipping (#23)." },
