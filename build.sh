...
GAME_SRCS="src/game.c src/audio.c src/particle.c src/vehicle.c src/physics.c src/tire.c src/drivetrain.c src/surface.c src/track.c src/collision.c src/scoring.c src/render.c src/replay.c src/telemetry.c $DEV_SRCS"
